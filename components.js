Demo = (function () {
    ...
    function CodeEditor(configs, listeners) {
        ...
        this.applyTrigger =  function (value){
        		self.editor.trigger('keyboard', 'type', {text: value});
        }
    }
    ...
    function addVariableToEditor(variableName){
    	//codeEditor =  validator().getCodeEditor()
    	var code = codeEditor.getValue();
    	//alert(code);
    	// below code will insert text "FOO"
		codeEditor.applyTrigger(variableName);
    }
